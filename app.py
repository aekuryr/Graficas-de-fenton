...
talla = st.number_input("Talla (cm)", min_value=30.0, max_value=60.0, value=51, step=0.1)
pc = st.number_input("Perímetro cefálico (cm)", min_value=20.0, max_value=55.0, value=35, step=0.1)
